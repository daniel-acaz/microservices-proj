package br.com.broscoder.hrpayroll.controller;

import br.com.broscoder.hrpayroll.model.Payment;
import br.com.broscoder.hrpayroll.service.PaymentService;
...
public class PaymentController {
    ...
    public ResponseEntity<?> getPaymentAlternative(Long workerId, Integer days) {
        Payment payment = new Payment("Bram", workerId * 1.0, days);
        return ResponseEntity.ok(payment);
    }
